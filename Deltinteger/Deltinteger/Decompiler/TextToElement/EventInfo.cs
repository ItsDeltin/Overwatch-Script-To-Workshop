...
namespace Deltin.Deltinteger.Decompiler.TextToElement
{
    public class EventInfo
    {
        ...
        public static readonly (string, PlayerSelector)[] PlayerTypeNames = new (string, PlayerSelector)[] {
            ...
            ("Vendetta", PlayerSelector.Vendetta),
