namespace Deltin.Deltinteger.Lobby
{
    public class HeroSettingCollection : LobbySettingCollection<HeroSettingCollection>
    {
        ...
        public static readonly HeroSettingCollection[] AllHeroSettings = new HeroSettingCollection[] {
            ...
            new HeroSettingCollection("Mercy").AddUlt("Valkyrie").AddProjectile(false).AddSecondaryFire().AddHealer().AddAbility("Guardian Angel").AddAbility("Regeneration", hasCooldown: false).AddAbility("Resurrect").AddSelect("Weapons Enabled", "All", "Caduceus Staff Only", "Caduceus Blaster Only"),
            ...
            new HeroSettingCollection("Torbjörn").AddUlt("Molten Core", hasDuration: true).AddProjectile(true).AddSecondaryFire().AddAbility("Deploy Turret").AddAbility("Overload").AddRange("Overload Duration Scalar").AddSelect("Weapons Enabled", "All", "Rivet Gun Only", "Forge Hammer Only"),
