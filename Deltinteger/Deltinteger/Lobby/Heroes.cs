    ...
    public class HeroSettingCollection : LobbySettingCollection<HeroSettingCollection>
    {
        ...
        public static void Init()
        {
            AllHeroSettings = new HeroSettingCollection[] {
                ...
                new HeroSettingCollection("Bastion").AddUlt("Configuration: Artillery", true).AddProjectile(true).AddAbility("Reconfigure").AddAbility("A-36 Tactical Grenade"),
                ...
                new HeroSettingCollection("Ramattra").AddUlt("Annihilation").AddProjectile(false).AddAbility("Void Barrier").AddAbility("Nemisis Form").AddAbility("Block", hasCooldown: false).AddAbility("Ravenous Vortex"),
