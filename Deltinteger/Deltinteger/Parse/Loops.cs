    ...
    class ForAction : LoopAction
    {
        ...
        void TranslateFor(ActionSet actionSet)
        {
            if (DefinedVariable != null)
            {
                ...
                DefinedVariable.GetInstance(actionSet.ThisTypeLinker).GetAssigner(actionSet).GetValue(actionSet);
            }
        ...
        void TranslateAutoFor(ActionSet actionSet)
        {
            ...
            else
            {
                ...
                var assignerResult = DefinedVariable.GetDefaultInstance().GetAssigner(actionSet).GetResult(new GettableAssignerValueInfo(actionSet) {
