...
namespace Deltin.Deltinteger.Parse
{
    ...
    class ReferenceCodeLensRange : CodeLensRange
    {
        ...
        */
        ...
        // public ReferenceCodeLensRange(ICallable callable, ParseInfo parseInfo, CodeLensSourceType sourceType, DocRange range) : base(sourceType, range, "editor.action.showReferences")
        public ReferenceCodeLensRange(ICallable callable, ParseInfo parseInfo, CodeLensSourceType sourceType, DocRange range) : base(sourceType, range, "ostw.testCommand")
        {
            Callable = callable;
        ...
        public override JArray GetArguments() => new JArray {
            _parseInfo.Script.Uri.ToString(),
            JsonConvert.SerializeObject(Range.start),
           new JArray(_parseInfo.TranslateInfo.GetSymbolLinks()[Callable].Select(loc => JsonConvert.SerializeObject(loc)))
        };
    }
}