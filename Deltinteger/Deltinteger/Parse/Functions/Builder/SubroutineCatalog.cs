...
namespace Deltin.Deltinteger.Parse.Functions.Builder
{
    ...
    public class SubroutineCatalogItem
    {
        ...
        public IGettable ObjectStack { get; } // Stores data about the subroutine's object instances. Will be a stack if recursive, a singular value otherwise.
        public ReturnHandler ReturnHandler { get; } // The subroutine's return handler.

        public SubroutineCatalogItem(Subroutine subroutine, IParameterHandler parameterHandler, IGettable objectStack, ReturnHandler returnHandler)
        {
