...
namespace Deltin.Deltinteger.GlobalFunctions
{
    ...
    {
        public static FuncMethod AngleFromVectors(DeltinScript deltinScript) => new FuncMethodBuilder() {
            Name = "AngleFromVectors",
            Documentation = "Gets the angle of 3 vectors in 3d space.",
            Parameters = new[] {
                new CodeParameter("vector1", "The first vector.", deltinScript.Types.Vector()),
                new CodeParameter("vector2", "The second vector.", deltinScript.Types.Vector()),
                new CodeParameter("vector3", "The third vector.", deltinScript.Types.Vector())
            },
            ...
            Action = (actionSet, methodCall) => {
                ...
                actionSet.AddAction(ArrayBuilder<Element>.Build(
                    // Save A
                    a.SetVariable(methodCall.Get(0)),
                    // Save B
                    b.SetVariable(methodCall.Get(1)),
                    // save C
                    c.SetVariable(methodCall.Get(2)),
